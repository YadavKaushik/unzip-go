...
const LOTTERY_GAMES = [
{ id: 'lottery-001', name: 'Win Go', subtitle: 'Guess the number', hot: true, gradient: 'linear-gradient(160deg, #4a0000 0%, #8B0000 50%, #C8102E 100%)', img: 'https://ossimg.lottery7lottery7.com/lottery77/lotterylogo/wingo.png', timer: 47 },
{ id: 'lottery-002', name: 'K3', subtitle: 'Guess the number', hot: false, gradient: 'linear-gradient(160deg, #FF8A65 0%, #FF6B5A 55%, #E64A45 100%)', img: 'https://ossimg.lottery7lottery7.com/lottery77/lotterylogo/k3.png', timer: 112 },
{ id: 'lottery-003', name: '5D', subtitle: 'Guess the number', hot: false, gradient: 'linear-gradient(160deg, #FFB199 0%, #F47A6E 55%, #C8102E 100%)', img: 'https://ossimg.lottery7lottery7.com/lottery77/lotterylogo/5d.png', timer: 203 },
{ id: 'lottery-004', name: 'Trx Win', subtitle: 'Guess the number', hot: false, gradient: 'linear-gradient(160deg, #FF7A6B 0%, #E84855 55%, #8B0000 100%)', img: 'https://ossimg.lottery7lottery7.com/lottery77/lotterylogo/trxwin.png', timer: 85 }];
